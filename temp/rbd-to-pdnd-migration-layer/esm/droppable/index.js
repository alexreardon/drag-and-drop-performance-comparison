...
export function Droppable(_ref) {
  ...
  var setElement = useCallback(function (element) {
    if (element) {
      ...
      setAttributes(element, (_setAttributes = {}, _defineProperty(_setAttributes, customAttributes.droppable.type, type), _defineProperty(_setAttributes, customAttributes.droppable.direction, direction), _defineProperty(_setAttributes, attributes.droppable.id, droppableId), _setAttributes));
    }
  ...
  var provided = useMemo(function () {
    ...
    return {
      innerRef: setElement,
      droppableProps: (_droppableProps = {}, _defineProperty(_droppableProps, attributes.droppable.contextId, ''), _defineProperty(_droppableProps, attributes.droppable.id, droppableId), _droppableProps),
