...
function Droppable(_ref) {
  ...
  var setElement = (0, _react.useCallback)(
    function (element) {
      if (element) {
        var _setAttributes;

        (0, _attributes.setAttributes)(
          element,
          ((_setAttributes = {}),
          (0, _defineProperty2.default)(
            _setAttributes,
            _attributes.customAttributes.droppable.type,
            type,
          ),
          (0, _defineProperty2.default)(
            _setAttributes,
            _attributes.customAttributes.droppable.direction,
            direction,
          ),
          (0, _defineProperty2.default)(
            _setAttributes,
            _attributes.attributes.droppable.id,
            droppableId,
          ),
          _setAttributes),
        );
      ...
      return {
        ...
        placeholder:
          isDraggingOver && state.source
            ? /*#__PURE__*/ _react.default.createElement(_dropIndicator.DropIndicator, {
                direction: direction,
                mode: mode,
                source: state.source,
  ...
  return /*#__PURE__*/ _react.default.createElement(
    _droppableContext.DroppableContextProvider,
    {
      value: contextValue,
    },
    children(provided, snapshot),
    shouldPortalDropIndicator &&
      /*#__PURE__*/ (0, _reactDom.createPortal)(provided.placeholder, element),
    renderClone &&
      /*#__PURE__*/ _react.default.createElement(
        _draggableClone.DraggableClone,
        {
          droppableId: droppableId,
          type: type,
