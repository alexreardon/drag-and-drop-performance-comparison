...
import { Column } from '../atlaskit-drag-and-drop/column';
  ...
  useEffect(() => {
    ...
    const disposeResource = waitForAllResources([
      ...
      importForInteraction(
        () =>
          import(
            /* webpackChunkName: "@atlaskit/drag-and-drop-hitbox/util/reorder-with-edge" */ '@atlaskit/drag-and-drop-hitbox/util/reorder-with-edge'
          ),
        {
          moduleId: '@atlaskit/drag-and-drop-hitbox/util/reorder-with-edge',
        },
      ),
    ]).onComplete(
      ([
        { combine },
        { monitorForElements, dropTargetForElements },
        { extractClosestEdge },
        { reorderWithEdge },
      ]) => {
